...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        Item item1 = new Item(1L, "Hobbit, czyli tam i spowrotem", "J.R.R. Tolkien", "fantasy",
                "audiobook", 21.46, 12, createImage("src/main/resources/static/resources/images/hobbit.jpg"),
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
        Item item2 = new Item(2L, "Harry Potter. Tom 1", "Rowling J. K.", "fantasy","audiobook",
                20.99, 3, createImage("src/main/resources/static/resources/images/harry.jpg"),
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
        Item item3 = new Item(3L,"Igrzyska śmierci. Tom 3", "Collins Suzanne", "fantasy","książka",
                17.21, 1, createImage("src/main/resources/static/resources/images/igrzyska.jpg"),
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
        Item item4 = new Item(4L, "Kubuś Puchatek", "Milne Alan Alexander", "dla dzieci","ebook",
                9.99, 23, createImage("src/main/resources/static/resources/images/puchatek.jpg"),
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
        Item item5 = new Item(5L, "Władca Pierścieni. Bractwo pierścienia.",
                "Tolkien John Ronald Reuel","fantasy","ebook", 47.81, 7,
                createImage("src/main/resources/static/resources/images/wladca.jpg"),
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
        Item item6 = new Item(6L, "Kubuś Puchatek", "Milne Alan Alexander", "dla dzieci","książka",
                9.99, 0, createImage("src/main/resources/static/resources/images/puchatek.jpg"),
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
        Item item7 = new Item(7L, "Kubuś Puchatek", "Milne Alan Alexander", "dla dzieci","audiobook",
                9.99, 10, createImage("src/main/resources/static/resources/images/puchatek.jpg"),
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
